import {
    Route, // determine what will be shown on our screen at the path
    Link, // actually take us to the path
    Switch // only one of the conditions is true at a time, so only one part of our application shows at a time
