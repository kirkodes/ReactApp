    ...
    return(
        <Container className='main'>
            <Row>
                <Col xs='12'>
                    <dl>
                        <h1> Functional Component Notes </h1>
                        <dd>They are the primary tool in React to build a small, modular piece of your page.</dd>
                        <dt>Can use state</dt>
                        <dd>With the 'useStat' hook, functional components can now both render a display to the page and update the information to be shown.</dd>
    ...
    return(
        <div>
            <Card>
                ...
                <CardBody>
                    <CardTitle>Regular Old Function</CardTitle>
